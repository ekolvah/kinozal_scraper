"""The navigation policy and its Claude PreToolUse adapters (#485, #534).
...
The second route is `Read` itself (#534): the same policy, applied to the byte size of
...
class TestReadBudget:
    """`Read` is the other route into the filesystem, and the one #485 left ungated (#534)."""
