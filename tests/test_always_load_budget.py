...
# правила (#369 стоил 950 B). То есть бамп ради нового норматива — штатный путь, а не аварийный:
# гейт покупает не дешевизну, а видимость платы. Аварийный случай — бамп ради текста, который при
# чтении диффа оказывается нарративом «как мы к этому пришли», а не правилом: такой текст
# переезжает в тело issue/PR под указатель `(#N)`, а не в бюджет.
_BUDGET_BYTES = 20_400
