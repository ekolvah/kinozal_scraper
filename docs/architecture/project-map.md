...
| `coverage-gaps.md` | Где мы сознательно **не** тестируем и почему: ledger `A`…`AH` со стабильными буквенными ID + модули без выделенных тестов. Выселен из `testing.md`, чтобы растущий список исключений не смешивался со стратегией | ✅ |
