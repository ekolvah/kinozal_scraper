...
| `test_telegram_summarizer.py` | `telegram_summarizer.py` | 25 | 5 |
| `test_telegram_notifier.py` | `telegram_notifier.py` | 24 | 8 |
| `test_sheets_storage.py` | `sheets_storage.py` | 22 | 4 |
| `test_steam_pipeline.py` | `steam_pipeline.py` | 21 | 7 |
| `test_github_trending_pipeline.py` | `github_trending_pipeline.py` | 19 | 7 |
