...
|---|---|---|---|
| `test_kinozal_pipeline.py` | `kinozal_pipeline.py` | 45 | 12 |
| `test_gemini_enricher.py` | `gemini_enricher.py` | 32 | 11 |
| `test_pipeline_config.py` | `pipeline_config.py` | 31 | 6 |
...
| `test_events_pipeline.py` | `events_pipeline.py` | 18 | 5 |
| `test_github_trending_pipeline.py` | `github_trending_pipeline.py` | 18 | 6 |
| `test_steam_pipeline.py` | `steam_pipeline.py` | 17 | 6 |
| `test_issue_branch.py` | `issue_branch.py` | 10 | 2 |
| `test_check_red.py` | `check_red.py` | 9 | 2 |
| `test_validate_issue_sections.py` | `validate_issue_sections.py` | 7 | 1 |
| `test_crypto.py` | `crypto.py` | 5 | 1 |
| `test_new_branch.py` | `new_branch.py` | 4 | 3 |
