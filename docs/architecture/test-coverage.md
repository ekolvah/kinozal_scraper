...
|---|---|---|---|
| `test_kinozal_pipeline.py` | `kinozal_pipeline.py` | 53 | 14 |
| `test_gemini_enricher.py` | `gemini_enricher.py` | 42 | 15 |
| `test_pipeline_config.py` | `pipeline_config.py` | 37 | 7 |
| `test_generic_pipeline.py` | `generic_pipeline.py` | 34 | 7 |
| `test_telegram_summarizer.py` | `telegram_summarizer.py` | 31 | 6 |
| `test_github_trending_pipeline.py` | `github_trending_pipeline.py` | 25 | 8 |
