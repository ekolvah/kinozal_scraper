...
| I. URL resolution | `test_kinozal_pipeline.py::TestKinozalUrls`, `TestBaseUrlResolution`, `TestKinozalEmptyUrlGuard::test_url_field_drift_logs_warning_and_skips_items`; `test_generic_pipeline.py::TestBuildNotificationLinks` | ✅ — kinozal items with empty `url` after extraction now emit WARNING and are skipped ([#56](https://github.com/ekolvah/kinozal_scraper/issues/56)) |
...
|---|---|---|---|
| `test_kinozal_pipeline.py` | `kinozal_pipeline.py` | 42 | 11 |
| `test_generic_pipeline.py` | `generic_pipeline.py` | 29 | 6 |
| `test_json_pipeline.py` | `json_pipeline.py` | 27 | 12 |
| `test_pipeline_config.py` | `pipeline_config.py` | 27 | 5 |
