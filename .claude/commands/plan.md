---
description: Структурировать body GitHub issue по 8 required секциям перед /implement
...
4. `gh issue edit $ARGUMENTS --body "<полный текст со всеми 8 секциями, включая ## Architect review и ## ADR>"`. Не выбрасывай существующий текст — только дополняй и реструктурируй.
