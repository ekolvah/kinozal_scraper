...
5. **Docs**: обнови `.md` из `## Docs to update`. Если сознательно отклонил покрытие (scope-/cost-skip, live-E2E как negative-ROI) — запиши это в ledger `docs/architecture/coverage-gaps.md` руками; автогенерации инвентаря тестов нет.
