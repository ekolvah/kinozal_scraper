#!/usr/bin/env python3
"""Reject new parser tests that construct external HTML inline (#509)."""
...
# These nodes predate #509. The ratchet freezes that debt without forcing a
# repository-wide migration unrelated to the incident.
GRANDFATHERED_NODES: frozenset[str] = frozenset(
    {
        "tests/test_generic_pipeline.py::TestExtractFromHtml::test_empty_html_quality_failure",
        "tests/test_generic_pipeline.py::TestExtractFromHtml::test_attr_extraction",
        "tests/test_kinozal_pipeline.py::TestParseGenre::test_extracts_multivalue_genre",
        "tests/test_kinozal_pipeline.py::TestParseGenre::test_returns_empty_when_no_genre_field",
        "tests/test_kinozal_pipeline.py::TestExtractDirectImageUrl::test_returns_empty_when_no_matching_img",
    }
)
